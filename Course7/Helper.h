...
//	}
//	
//	stClient ConvertLineToRecord(string line, string seperator = "#//#")		// · ÕÊÌ· «·”ÿ— „‰ «·„·› «·Ï »‰Ì… «·⁄„Ì· 
//	{
...
//	}
//		
//	string ConvertRecordToLine(stClient client,string seperator = "#//#")		// · ÕÊÌ· »‰Ì… «·⁄„Ì· «·Ï ”ÿ— ·«÷«› Â ≈·Ï «·„·›
//	{
//		string clientRecord = "";
//
...
//	}
//
//	bool SaveDataInFlie(const vector<stClient>& vClients, const string& filePath)		// ·Õ›Ÿ «·„·› »⁄œ Õ–› ⁄„Ì· „‰Â Ê „—«Ã⁄… ›ﬂ—… overlodaing
//	{
//		fstream myFile;
...
//	}
//		
//	bool GetUserAnswerForDeletion()				// ·”ƒ«· «·„” Œœ„ ⁄·Ï  √ﬂÌœ Õ–› «·⁄„Ì· 
//	{
//		char deleted = 'y';
...
//	}
//
//	bool GetUserAnswerForUpdate()		// ·”ƒ«· «·„” Œœ„ ⁄·Ï  √ﬂÌœ  ⁄œÌ· «·⁄„Ì· 
//	{
//		char deleted = 'y';
